...
void set_controller()
{
	...
	periodic_move_x.set_task(10000000, 100000, 100000, 50, 100);
...
void setup(){
	...
	//str = S2S.mbuild(uint_to_hexcode8(100000), 3, 1);
	//Serial6.simulation_input(str.c_str(), str.length());

	//str = S2S.mbuild(uint_to_hexcode8(1000), 4, 2);
	//Serial6.simulation_input(str.c_str(), str.length());

	//str = S2S.mbuild(uint_to_hexcode8(0), 14, 2);
	//Serial6.simulation_input(str.c_str(), str.length());
};
