...
//Mirm: Waiter должен состоять из трёх информационных полей:
// - Тип условия анвэйта.
// - Тип действия по осуществлению анвэйта.
// - Дополнительная информация, регламентирующая поведение
// диспетчера по отношению к вэйтеру. (Если вэйтер создавался 
// автоматически, он должен быть  удалён. Если для вэйтера 
// создавался делегат, он должен быть удалён и т.д.)
//
// И двух полей данных:
// - Поле условия
// - Поле действия.
//
// Вэйтер должен позволять отмену воздействия. Скорее всего,
// это не нужно для автоматически создаваемых вэйтеров.
//
// Условную компиляцию следует ликвидировать, заменить 
// на модули. Обязательно ставить error_stub.
