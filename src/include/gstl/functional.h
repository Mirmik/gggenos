...
namespace std{
	...
	template <class Predicate> class   binary_negate : public
	...
	template <class Arg1, class Arg2, class Result>	class   
...
template <class Op1, class Op2, class Op3> inline   binary_compose<Op1, Op2, Op3>
